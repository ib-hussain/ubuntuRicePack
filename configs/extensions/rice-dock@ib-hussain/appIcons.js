...
, class DockShowAppsIcon extends Dash.ShowAppsIcon {
    ...
    _createIcon(size) {
        ...
        // symbolic icon, a GIcon and a CSS background simultaneously, which is
        // why Ubuntu rendered the Arch logo over a white app-grid tile.
        ...
        this._iconActor.fallbackGicon = logo;
